...
CREATE TABLE Transactions (
    ...
    amountPaid NUMBER(10) DEFAULT 0 NOT NULL,
    CONSTRAINT chk_trans_paid CHECK (amountPaid >= 0)
);
...
ALTER TABLE Receipt ADD CONSTRAINT FK_Receipt_Employee FOREIGN KEY (employeeId) REFERENCES Employee(employeeId);
